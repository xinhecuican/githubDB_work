...
list1 = glob.glob("ORC PLB IDM 2007/train_graphs/*.npy")
#print(list1[0][21:25])
...
list1 = glob.glob("ORC PLB IDM 2007/test_graphs/*.npy")
#print(list1[0][21:25])
for i in range(len(list1)):
...
cnt = 0
for t in test_list:
    temp = np.load("ORC PLB IDM 2007/test_graphs/"+t+"_10_15.npy", allow_pickle=True)
    ...
    cnt += 1
np.save("ORC PLB IDM 2007/test_set_"+str(fp)+"_model_4.npy", test_set)
...
cnt = 0
for t in train_list:
    temp = np.load("ORC PLB IDM 2007/train_graphs/"+t+"_10_15.npy", allow_pickle=True)
    print("Processing: ", t, cnt)
    train_features = []
    for i in range(len(temp)):
        temp_feature = []
    ...
    cnt += 1
np.save("ORC PLB IDM 2007/train_set_"+str(fp)+"_model_4.npy", train_set)

"""
X_train = np.load("ORC PLB IDM 2007/train_set_"+str(fp)+"_model_4.npy", allow_pickle=True)
X_test = np.load("ORC PLB IDM 2007/test_set_"+str(fp)+"_model_4.npy", allow_pickle=True)
...
np.save("ORC PLB IDM 2007/results_"+str(fp)+"_model_4.npy", [results, gbt_values, rf_values])
"""